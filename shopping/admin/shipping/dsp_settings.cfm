...
To use UPS<sup>&reg;</sup> Rates and Tracking, first register for access at the <a hread="http://www.ups.com/content/us/en/resources/techsupport/developercenter.html">UPS Developer Center</a>.  
Then follow the link below to enter your access credentials and default shipping address information. After completing this step and returning to this page you will see links to configure the rest of the UPS settings and shipping methods.
...
Define your Custom Shipping Rates in the Shipping Table. You can also add a shipping surchage on a per country basis using the Country Rates table, or for additional shipping methods in the Shipping Methods section. These amounts are calculated before adding in the base rate and handling percentage.
		...
		<cfelseif attributes.shiptype is "UPS">
			...
			<li><a href="#self#?fuseaction=shopping.admin&shipping=upsinfo#Request.Token2#">UPS Developer API Settings</a></li>
		...
		<cfelseif attributes.shiptype is "FedEx">
			...
			<li><a href="#self#?fuseaction=shopping.admin&shipping=fedexinfo#Request.Token2#">FedEx Web Services Settings</a></li>
