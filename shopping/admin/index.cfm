		...
		<cfswitch expression="#attributes.shipping#">
			...
			<cfcase value="customsettings">
				<cfif isdefined("attributes.submit_custom")>
					...
					<!--- save confirmation --->
					<cfset attributes.XFA_success="fuseaction=shopping.admin&shipping=editsettings">
			...
			<cfcase value="upsinfo">
				<cfif isdefined("attributes.submit_ups")>
					...
					<!--- save confirmation --->
					<cfset attributes.XFA_success="fuseaction=shopping.admin&shipping=editsettings">
					<cfset attributes.box_title="UPS Developer API Settings">
					<cfinclude template="../../includes/admin_confirmation.cfm">	
				<cfelse>
			...
			<cfcase value="fedexinfo">
				<cfif isdefined("attributes.submit_fedex")>
					<cfinclude template="shipping/fedex/act_fedexinfo.cfm">
					<!--- save confirmation --->
					<cfset attributes.XFA_success="fuseaction=shopping.admin&shipping=editsettings">
					<cfset attributes.box_title="Fedex Web Services Settings">
					<cfinclude template="../../includes/admin_confirmation.cfm">	
				<cfelse>
					<cfinclude template="shipping/fedex/dsp_fedexinfo.cfm">
				</cfif>
			</cfcase>	
