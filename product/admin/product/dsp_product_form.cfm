...
<cfset ck_dirname="&dirname=/products">
<cfset ck_user = "&user=#attributes.user_ID#">
...
<!--- Listing Title --->
 ...
 <!--- Short Description --->
			<tr>
				...
				<textarea id="short_desc" name="Short_Desc">#attributes.Short_Desc#</textarea>
				<script type="text/javascript">
				CKEDITOR.replace( 'short_desc', { #ck_default# #ck_image#
				 #basic_tool#,
				 height:150 } );
				 </script>
				</td>
...
<!--- Enlarged Image --->
 ...
 <!--- Long Description --->
			<tr>
				...
				<br/>	
				<textarea id="long_desc" name="Long_Desc">#attributes.Long_Desc#</textarea>
				<script type="text/javascript">
				CKEDITOR.replace( 'long_desc', { #ck_default# #ck_image#
...
objForm.required("Name,prod_display,Highlight,sale,hot");
objForm.prod_display.description = "display";
