...
<!--- Username --->
			<tr>
				...
				<td style="background-color: ###Request.GetColors.formreq#;" width="3">&nbsp;</td>
		 		<td><input type="text" name="username" value="#HTMLEditFormat(attributes.username)#" size="30" maxlength="100" class="formfield"/></td>
			</tr>
 ...
 <!--- Email --->
			<tr>
				...
				<td style="background-color: ###Request.GetColors.formreq#;"></td>
				<td><input type="text" name="email" value="#HTMLEditFormat(attributes.email)#" size="30" maxlength="100" class="formfield"/> 
...
<cfif get_User_Settings.UseCCard AND get_Order_Settings.CCProcess IS "Shift4OTN">
	...
	<tr><td></td><td colspan="2"><strong>CREDIT CARD</strong></td></tr>
	<tr><td></td><td colspan="2">(Enter all fields below, or none if no credit card data)</td></tr>
 ...
 <!--- Is Active --->	
			<tr>
				...
				<td></td>		
				<td>
				<input type="radio" name="CardisValid" value="0" #doChecked(attributes.CardisValid,0)# />Approval Pending
 ...
 <!--- CardType --->	
			<tr>
				...
				<td></td>
		 		<td><select name="CardType" size="1" class="formfield">
 ...
 <!--- NameOnCard --->		
			<tr>
				...
				<td></td>
		 		<td><input type="text" name="NameOnCard"  value="#HTMLEditFormat(attributes.NameOnCard)#" size="20" maxlength="80" class="formfield"/></td>
			</tr>
 ...
 <!--- CardNumber --->
			<tr>
				...
				<td></td>
		 		<td><input type="text" name="CardNumber" value="#HTMLEditFormat(attributes.CardNumber)#" size="20" maxlength="30" class="formfield"/></td>
			</tr>
 ...
 <!--- Disable --->
 	...
 	<!--- Notes --->
			...
			<tr>
				...
				<textarea id="AdminNotes" name="AdminNotes">#attributes.AdminNotes#</textarea>
				<script type="text/javascript">
				CKEDITOR.replace( 'AdminNotes', { #ck_default# #ck_image#
				 #basic_tool#,
				 height: 200 } );
				</script>
			</td>
