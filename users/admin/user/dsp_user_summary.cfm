...
<!--- For CSRF checks --->
<cfset userformkey = CreateUUID()>
<cfset session.formKeys.userEdit = userformkey>
<cfset memformkey = CreateUUID()>
<cfset session.formKeys.billRecurring = memformkey>
<cfset session.formKeys.approveMember = memformkey>
...
<strong>User:</strong> <cfif NOT get_User_Settings.EmailAsName><a href="#self#?fuseaction=users.admin&user=edit&UID=#attributes.uid#&XFA_success=#URLEncodedFormat(cgi.query_string)##Request.Token2#">#HTMLEditFormat(qry_get_user.Username)#</a><br/>
<strong>Email:</strong> </cfif>
<a href="mailto:#qry_get_user.Email#">#HTMLEditFormat(qry_get_user.Email)#</a>
		</td>
		<td width="50%" valign="top">	 
...
<cfif len(qry_get_user.emailLock) AND qry_get_user.emailLock is NOT "verified">
					[ <a href="#self#?fuseaction=users.admin&user=unlock&uid=#attributes.uid#&formkey=#Hash(userformkey,"SHA-256")#&XFA_success=#URLEncodedFormat(cgi.query_string)##Request.Token2#">unlock</a> ]
...
<strong>Group:</strong> #qry_get_user.GroupName#<br/>		
		...
		<strong><font color="red">BLOCKED</font></strong>&nbsp;&nbsp; [ <a href="#self#?fuseaction=users.admin&user=unblock&formkey=#Hash(userformkey,"SHA-256")#&uid=#qry_get_user.user_ID##Request.Token2#">Unblock</a> ]
		</cfif>
		</td>
	</tr>
