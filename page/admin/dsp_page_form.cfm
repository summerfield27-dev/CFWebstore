	...
	<!--- Long Description --->
		<tr>
			<td colspan="3" align="center">							
				<br/>
			<textarea id="pageText" name="PageText">#attributes.PageText#</textarea>
			<script type="text/javascript">
				CKEDITOR.replace( 'pageText', { #ck_default# #ck_image#
...
objForm.required("page_name,Page_Display");
objForm.Page_Display.description = "display in menu";
